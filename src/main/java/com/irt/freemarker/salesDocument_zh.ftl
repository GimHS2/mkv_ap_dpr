	...
	<div id="page-content" data-lang="${header.displayLanguage}">
		...
		<div id="details">
			...
			<div id="details-content-top" class="column-group column-group_3">
				<div id="details-content-top-left" class="column-item" style="width: 22%;">
					<div class="column-row" style="padding-left:8px;">
						<table style="table-layout: fixed; width: 100%;">
							<tr>
								...
								<td class="content width70 underline" style="text-align: left; text-decoration: underline;">
				...
				<div id="details-content-top-center" class="column-item" style="width: 51%;">
					<div class="column-row">
						<span>&nbsp;</span>
					</div>
				</div>
				<div id="details-content-top-right" class="column-item" style="width: 22%;">
					<table style="table-layout: fixed; width: 100%;">
						<tbody>
							<tr>
			...
			<div id="details-content-main">
				<table>
					<colgroup>
						...
						<col class="col_4char string"></col>
						<!-- <col class="col_8char string" style="width: 80px;"></col> -->
						<col class="col_8char string"></col>
						<col class="col_2char string"></col>
						<!-- <col class="col_1char number" style="width: 60px;"></col> -->
					...
					<thead>
						<tr>
							...
							<#if charLen0 != 0>
							<#assign w = charLen0 * wordRate>
							<th style="width: ${w}em;">${labels.itemExtraCate}</th>
							<#else>
							<th>${labels.itemExtraCate}</th>
							</#if>

							<#if charLen1 != 0>
							<#assign w = charLen1 * codeRate>
							<th style="width: ${w}em;">${labels.itemNumber}</th>
							<#else>
							<th>${labels.itemNumber}</th>
							</#if>

							<#if charLen2 != 0>
							<#assign w = charLen2 * wordRate>
							<th style="width: ${w}em;">${labels.itemExtraDesc}</th>
							<#else>
							<th>${labels.itemExtraDesc}</th>
							</#if>

							<th>${labels.itemExtraAbbrev}</th>
							<th>${labels.itemExtraSpec}</th>
							<th>${labels.uomNameLocal}</th>
							<th>${labels.lineOrderCaseQty}</th>
							<th>${labels.lineOrderPieceQty}</th>
							<#assign w = labels.lineOrderPiecePrice?length * 0.9>
							<th style="width: ${w}em;">${labels.lineOrderPiecePrice}</th>
							<#assign w = labels.lineOrderValue?length * 1.1>
							<th style="width: ${w}em;">${labels.lineOrderValue}</th>
							<#assign w = labels.lineOrderTax?length * 1.2>
							<th style="width: ${w}em;">${labels.lineOrderTax}</th>
							<#assign w = labels.lineOrderTotal?length * 1.1>
							<th style="width: ${w}em;">${labels.lineOrderTotal}</th>
						</tr>
					</thead>
					<tfoot>
						<tr>
		...
		<div id="tail">
			...
			<div id="tail-content" class="column-group column-group_5">
				<div id="tail-content-top">
					<div id="tail-content-top-left" class="column-item" style="width: 30%;">
						<div class="column-row">
							<table style="table-layout: fixed; width: 100%;">
								<tr>
									<td class="subject bold">
									...
									<td class="content underline" style="width: 60%;"></td>
						...
						<div class="column-row">
							<table style="table-layout: fixed; width: 100%;">
								<tr>
									...
									<td class="content bold width80">
										<span> ${header.organizationAddress?html}</span>
									</td>
								</tr>
							</table>
						</div>
					...
					<div class="column-item" style="width: 10%">
						<div class="column-row">
							<span>&nbsp;</span>
						</div>
					</div>
					<div id="tail-content-top-center" class="column-item" style="width: 20%;">
						<div class="column-row">
							<table style="table-layout: fixed; width: 100%;">
								<tr>
									<td class="subject bold">
						...
						<div class="column-row">
							<table style="table-layout: fixed; width: 100%;">
								<tr>
									...
									<td class="content underline" style="text-align: center;">
					...
					<div class="column-item" style="width: 16.2%">
						<div class="column-row">
							<span>&nbsp;</span>
						</div>
					</div>
					<div id="tail-content-top-right" class="column-item" style="border: solid 1.5px; width: 20%;">
						<div class="column-row">
							<table style="table-layout: fixed; width: 100%;">
								<tr>
									<td class="subject">
