<%--
	File Name:	usr_party_select.jsp
	Version:	2.2.0
	...
	<mtl:form name="frmMain" onSubmit="JavaScript: return false;">
		<mtl:contentGroup groupId="list" type="list">
			...
			<%
				...
				factory.setPrimaryFieldKeys( new String[] { "partyId", "partyName" } );
				factory.appendColumn( "partyName", "&nbsp;", "class='description'" );
			...
			<tr>
				<td class='list_content_bottom' align='left' nowrap>
					<select name='filterType'>
						<option value='partyId'><mtl:message key="FIELD_PARTYID"/></option>
						<option value='partyName' selected><mtl:message key="FIELD_USR_PARTYNAME"/></option>
					</select>
