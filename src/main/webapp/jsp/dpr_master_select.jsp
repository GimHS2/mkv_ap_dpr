<%--
	...
	stghr12		2006/02/28		2.0.0	version up(sys_code_select.jsp -> pub_code_select.jsp)
	...
	<mtl:form name="frmMain" onSubmit="JavaScript: return false;">
		<mtl:contentGroup groupId="list" type="list">
			...
			<%
				...
				factory.appendColumn( "organizationCode", "&nbsp;", "width='30' align='center'" );
				factory.appendColumn( "organizationName", "&nbsp;", "class='description'" );
				factory.setPrimaryFieldKeys( new String[] { "organizationCode" } );
